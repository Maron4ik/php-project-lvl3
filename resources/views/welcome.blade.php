...
<head>
    ...
    <!-- CSRF Token -->
    <meta name="csrf-token" content="NYKyzluUiYSvnWZMhFpJq3Us0UyST5E8zTwbX7QW">
    ...
    <style data-styled="" data-styled-version="4.4.1">
        ...
        .apexcharts-tooltip {
            ...
            box-shadow: 0 2px 10px rgba(9, 19, 80, 0.12316), 0 3px 2px rgba(128, 128, 128, 0.058707), inset 0 0 3px rgba(255, 255, 255, 0.5) !important;
        ...
        .apexcharts-series-markers-wrap > g:not(:last-of-type) circle[r='4.6'] {
            fill: white;
            stroke: #4da1ff;
        }
...
<footer class="border-top py-3 mt-5 flex-shrink-0">
    <div class="container-lg">
        <div class="text-center">
            <a href="/" target="_blank">Maron Alexey</a>
        </div>
    </div>
</footer>
...
<div id="gadsf21g">
    <div>
        <div class="Font-sc-zlhigq idauOE"></div>
    </div>
</div>
</body>
</html>
